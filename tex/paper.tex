...
\begin{figure}[ht]
  ...
  \drules[TWF]{$\nonterm G \vdash \nonterm{ts}$}{type well-formedness}{TrueRef,Base,Conj,Arr,ADT}
...
\begin{figure}[ht]
  \footnotesize
  \drules[E]{$\nonterm{es}_1 \evalsto \nonterm{es}_2$}{term evaluation}{AppL,AppR,AppAbs,ADT,CaseScrut,CaseMatch}
...
\begin{figure}[ht]
  \footnotesize
  \drules[CE]{$\nonterm{ec}_1 \evalsto \nonterm{ec}_2$}{term evaluation}{AppL,AppR,AppAbs,ADT,CaseScrut,CaseMatch}
