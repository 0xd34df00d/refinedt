...
\begin{figure}[ht]
  \footnotesize
  \drules[TWF]{$\nonterm G \vdash \nonterm t \text{ ok}$}{type well-formedness}{TrueRef,Base,Conj,Arr}
  \drules[T]{$\nonterm G \vdash \nonterm e : \nonterm t$}{term typing}{BoolTop,BoolBot,Var,Abs,App,If,Sub}
  \drules[ST]{$\nonterm G \vdash \nonterm t_1 <: \nonterm t_2$}{subtyping}{Base,Arr}
