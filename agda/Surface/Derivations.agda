...
record PositiveDecision (Γ : Ctx ℓ) (b : BaseType) (ρ₁ ρ₂ : Refinement (suc ℓ)) : Set
...
record PositiveDecision Γ b ρ₁ ρ₂ where
  constructor MkPD
  field
    witness : STerm ℓ
    witness-well-typed : Γ ⊢ witness ⦂ ⟨ b ∣ ρ₁ ⟩ ⇒ ⟨ b ∣ R.weaken-ρ ρ₂ ⟩
