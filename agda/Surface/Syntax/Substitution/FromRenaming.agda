...
ρ-as-σ-ρ ρ (ε₁ ≈ ε₂) rewrite ρ-as-σ-ε ρ ε₁
                           | ρ-as-σ-ε ρ ε₂ = refl
ρ-as-σ-ρ ρ (ρ₁ ∧ ρ₂) rewrite ρ-as-σ-ρ ρ ρ₁
                           | ρ-as-σ-ρ ρ ρ₂ = refl
...
ρ-as-σ-ε ρ (SApp ε₁ ε₂) rewrite ρ-as-σ-ε ρ ε₁
                              | ρ-as-σ-ε ρ ε₂ = refl
...
ρ-as-σ-branches ρ (MkCaseBranch ε ∷ bs) rewrite ρ-as-σ-ε (R.ext ρ) ε
                                              | act-ε-extensionality (var-ext-commutes ρ) ε
                                              | ρ-as-σ-branches ρ bs = refl
