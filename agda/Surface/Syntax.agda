...
substInTerm x ε (SVar var) = {! SVar !}
substInTerm x ε (SLam var τ ε') = SLam {!  !} {! !} {! !}
substInTerm x ε (SApp ε₁ ε₂) = SApp {! !} {! !}
substInTerm x ε SUnit = SUnit
substInTerm x ε (SCase e branches) = {! !}
substInTerm x ε (SCon idx e adtCons) = {! !}
